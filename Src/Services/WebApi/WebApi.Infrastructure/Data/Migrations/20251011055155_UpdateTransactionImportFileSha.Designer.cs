...
namespace WebApi.Infrastructure.Data.Migrations
{
    ...
    [Migration("20251011055155_UpdateTransactionImportFileSha")]
    partial class UpdateTransactionImportFileSha
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Core.Entities.TransactionImportRow", b =>
                {
                    ...
                    b.Property<Guid?>("DuplicateOfRowId")
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("RawBalanceText")
                        .HasColumnType("text");

                    b.Property<string>("RawCounterparty")
                        .HasMaxLength(512)
                        .HasColumnType("character varying(512)");
                    ...
                    b.Property<int>("RawLineNumber")
                        .HasColumnType("integer");

                    b.Property<string>("RawRecordJson")
                        .IsRequired()
                        .HasColumnType("jsonb");
                    ...
                    b.HasIndex("ImportBatchId", "RawFitId")
                        .IsUnique()
                        .HasFilter("\"RawFitId\" IS NOT NULL");

                    b.HasIndex("ImportBatchId", "RawHash")
                        .IsUnique()
                        .HasFilter("\"RawHash\" IS NOT NULL");

                    b.HasIndex("ImportBatchId", "RawLineNumber")
                        .IsUnique();

                    b.HasIndex("ImportBatchId", "Status");

                    b.HasIndex("Status", "StatusAtUtc");

                    b.ToTable("TransactionImportRow", "import", t =>
                        {
