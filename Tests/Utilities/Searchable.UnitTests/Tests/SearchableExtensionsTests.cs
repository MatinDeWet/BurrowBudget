...
public class SearchableExtensionsTests
{
    ...
    #region ILikeSearch Single Property Tests

    [Fact]
    public void ILikeSearch_SingleProperty_WithEmptySearchTerm_ShouldReturnOriginalQueryable()
    {
        // Arrange
        IQueryable<TestProduct> testData = GetTestProducts().AsQueryable();

        // Act
        IQueryable<TestProduct> results = testData.ILikeSearch("", p => p.Name);
    ...
    [Fact]
    public void ILikeSearch_SingleProperty_WithNullSearchTerm_ShouldReturnOriginalQueryable()
    {
        // Arrange
        IQueryable<TestProduct> testData = GetTestProducts().AsQueryable();

        // Act
        IQueryable<TestProduct> results = testData.ILikeSearch(null, p => p.Name);
    ...
    [Fact]
    public void ILikeSearch_SingleProperty_WithWhiteSpaceSearchTerm_ShouldReturnOriginalQueryable()
    {
        // Arrange
        IQueryable<TestProduct> testData = GetTestProducts().AsQueryable();
    ...
    [Fact]
    public void ILikeSearch_SingleProperty_WithValidSearchTerm_ShouldApplyFilter()
    {
        // Arrange
        IQueryable<TestProduct> mockData = new List<TestProduct>
        {
            new() { Id = 1, Name = "Test Product", Description = "Description" },
            new() { Id = 2, Name = "Sample Product", Description = "Another description" }
        }.AsQueryable();

        // Act
        IQueryable<TestProduct> query = mockData.ILikeSearch("test", p => p.Name);
    ...
    [Theory]
    [InlineData(ILikeMatchModeEnum.Contains)]
    [InlineData(ILikeMatchModeEnum.StartsWith)]
    [InlineData(ILikeMatchModeEnum.EndsWith)]
    [InlineData(ILikeMatchModeEnum.Exact)]
    public void ILikeSearch_SingleProperty_WithDifferentMatchModes_ShouldApplyFilter(ILikeMatchModeEnum matchMode)
    {
        // Arrange
        IQueryable<TestProduct> mockData = GetTestProducts().AsQueryable();

        // Act
        IQueryable<TestProduct> query = mockData.ILikeSearch("test", p => p.Name, matchMode);
    ...
    [Fact]
    public void ILikeSearch_SingleProperty_WithDefaultMatchMode_ShouldUseContains()
    {
        // Arrange
        IQueryable<TestProduct> mockData = GetTestProducts().AsQueryable();
        ...
        // Assert
        query.ShouldNotBeSameAs(mockData);
        // Default should be Contains mode
        query.Expression.ToString().ShouldContain("Where");
    }

    [Fact]
    public void ILikeSearch_SingleProperty_WithSearchTermThatBecomesEmptyAfterCleaning_ShouldReturnOriginalQueryable()
    {
        // Arrange
        IQueryable<TestProduct> testData = GetTestProducts().AsQueryable();

        // Act - Use a search term that becomes empty after cleaning
        IQueryable<TestProduct> results = testData.ILikeSearch("   ", p => p.Name);
    ...
    #region ILikeSearch Multiple Properties Tests

    [Fact]
    public void ILikeSearch_MultipleProperties_WithEmptySearchTerm_ShouldReturnOriginalQueryable()
    {
        // Arrange
        IQueryable<TestProduct> testData = GetTestProducts().AsQueryable();
        Expression<Func<TestProduct, string>>[] properties = [p => p.Name, p => p.Description];

        // Act
        IQueryable<TestProduct> results = testData.ILikeSearch("", properties);
    ...
    [Fact]
    public void ILikeSearch_MultipleProperties_WithNullSearchTerm_ShouldReturnOriginalQueryable()
    {
        // Arrange
        IQueryable<TestProduct> testData = GetTestProducts().AsQueryable();
        Expression<Func<TestProduct, string>>[] properties = [p => p.Name, p => p.Description];
        ...
        // Act
        IQueryable<TestProduct> results = testData.ILikeSearch(null, properties);
    ...
    [Fact]
    public void ILikeSearch_MultipleProperties_WithNullProperties_ShouldReturnOriginalQueryable()
    {
        // Arrange
        IQueryable<TestProduct> testData = GetTestProducts().AsQueryable();

        // Act
        IQueryable<TestProduct> results = testData.ILikeSearch("test", (Expression<Func<TestProduct, string>>[])null!);
    ...
    [Fact]
    public void ILikeSearch_MultipleProperties_WithEmptyPropertiesArray_ShouldReturnOriginalQueryable()
    {
        // Arrange
        IQueryable<TestProduct> testData = GetTestProducts().AsQueryable();
        Expression<Func<TestProduct, string>>[] properties = [];

        // Act
        IQueryable<TestProduct> results = testData.ILikeSearch("test", properties);
    ...
    [Fact]
    public void ILikeSearch_MultipleProperties_WithValidSearchTerm_ShouldApplyFilter()
    {
        // Arrange
        IQueryable<TestProduct> mockData = GetTestProducts().AsQueryable();
        Expression<Func<TestProduct, string>>[] properties = [p => p.Name, p => p.Description];
        ...
        // Act
        IQueryable<TestProduct> query = mockData.ILikeSearch("test", properties);
    ...
    [Fact]
    public void ILikeSearch_MultipleProperties_WithOrLogic_ShouldApplyFilter()
    {
        // Arrange
        IQueryable<TestProduct> mockData = GetTestProducts().AsQueryable();
        Expression<Func<TestProduct, string>>[] properties = [p => p.Name, p => p.Description];
        ...
        // Act
        IQueryable<TestProduct> query = mockData.ILikeSearch("test", properties, ILikeMatchModeEnum.Contains, useOrLogic: true);
    ...
    [Fact]
    public void ILikeSearch_MultipleProperties_WithAndLogic_ShouldApplyFilter()
    {
        // Arrange
        IQueryable<TestProduct> mockData = GetTestProducts().AsQueryable();
        Expression<Func<TestProduct, string>>[] properties = [p => p.Name, p => p.Description];
        ...
        // Act
        IQueryable<TestProduct> query = mockData.ILikeSearch("test", properties, ILikeMatchModeEnum.Contains, useOrLogic: false);
    ...
    [InlineData(ILikeMatchModeEnum.EndsWith)]
    [InlineData(ILikeMatchModeEnum.Exact)]
    public void ILikeSearch_MultipleProperties_WithDifferentMatchModes_ShouldApplyFilter(ILikeMatchModeEnum matchMode)
    {
        // Arrange
        IQueryable<TestProduct> mockData = GetTestProducts().AsQueryable();
        Expression<Func<TestProduct, string>>[] properties = [p => p.Name, p => p.Description];
        ...
        // Act
        IQueryable<TestProduct> query = mockData.ILikeSearch("test", properties, matchMode);
    ...
    [Fact]
    public void ILikeSearch_MultipleProperties_WithDefaultValues_ShouldUseContainsAndOrLogic()
    {
        // Arrange
        IQueryable<TestProduct> mockData = GetTestProducts().AsQueryable();
        Expression<Func<TestProduct, string>>[] properties = [p => p.Name, p => p.Description];
    ...
    [Fact]
    public void ILikeSearch_MultipleProperties_WithThreeProperties_ShouldApplyFilter()
    {
        // Arrange
        IQueryable<TestProduct> mockData = GetTestProducts().AsQueryable();
        Expression<Func<TestProduct, string>>[] properties = [p => p.Name, p => p.Description, p => p.Category];
    ...
    #region CleanSearchTermForILike Tests

    [Fact]
    public void CleanSearchTermForILike_ShouldTrimInput()
    {
        // Act
        string result = InvokeCleanSearchTermForILike("  test term  ");
    ...
    [Fact]
    public void CleanSearchTermForILike_WithNullInput_ShouldReturnEmptyString()
    {
        // Act
        string result = InvokeCleanSearchTermForILike(null!);
    ...
    [Fact]
    public void CleanSearchTermForILike_WithEmptyInput_ShouldReturnEmptyString()
    {
        // Act
        string result = InvokeCleanSearchTermForILike("");
    ...
    [Fact]
    public void CleanSearchTermForILike_WithWhiteSpaceInput_ShouldReturnEmptyString()
    {
        // Act
        string result = InvokeCleanSearchTermForILike("   ");
    ...
    [InlineData("test_search", "test\\_search")]
    [InlineData("test\\search", "test\\\\search")]
    [InlineData("test%_search", "test\\%\\_search")]
    public void CleanSearchTermForILike_ShouldEscapeILikeSpecialCharacters(string input, string expected)
    {
        // Act
        string result = InvokeCleanSearchTermForILike(input);
    ...
    [Fact]
    public void CleanSearchTermForILike_ShouldEscapeBackslashesFirst()
    {
        // Act
        string result = InvokeCleanSearchTermForILike("test\\%search");

        // Assert
        result.ShouldBe("test\\\\\\%search"); // Backslash escaped first, then percent
    }

    [Fact]
    public void CleanSearchTermForILike_WithVeryLongInput_ShouldTruncateToMaxLength()
    {
        // Arrange
        string longInput = new('a', 1500); // Longer than max length (1000)

        // Act
        string result = InvokeCleanSearchTermForILike(longInput);
    ...
    [Fact]
    public void CleanSearchTermForILike_TruncationShouldTrimEndSpaces()
    {
    ...
    [Fact]
    public void CleanSearchTermForILike_WithComplexRealWorldExample_ShouldProcessCorrectly()
    {
        // Arrange - Simulate a real-world search with ILIKE special characters
        string input = "  search  for  items  with  50%  discount  and  special_code  ";

        // Act
        string result = InvokeCleanSearchTermForILike(input);

        // Assert - ILIKE cleaning preserves spaces, only trims and escapes special chars
        result.ShouldBe("search  for  items  with  50\\%  discount  and  special\\_code");
    }
    ...
    public void CleanSearchTermForILike_WithNormalInput_ShouldReturnTrimmedOnly(string input)
    {
        // Act
        string result = InvokeCleanSearchTermForILike($"  {input}  ");
    ...
    private string InvokeCleanSearchTermForILike(string input)
    {
        MethodInfo? method = typeof(SearchableExtensions).GetMethod("CleanSearchTermForILike",
            BindingFlags.NonPublic | BindingFlags.Static)
            ?? throw new InvalidOperationException("The method 'CleanSearchTermForILike' could not be found.");
    ...
    private List<TestProduct> GetTestProducts()
    {
        return
        [
            new() { Id = 1, Name = "Test Product 1", Description = "This is test description", Category = "Electronics", Brand = "TestBrand" },
            new() { Id = 2, Name = "Sample Product", Description = "Another sample description", Category = "Clothing", Brand = "SampleBrand" },
            new() { Id = 3, Name = "Premium Product", Description = "Premium quality description", Category = "Electronics", Brand = "PremiumBrand" }
        ];
    }
